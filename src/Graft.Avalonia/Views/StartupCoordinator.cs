...
///
/// WPF版からの移植（19章 L3）。OS固有の機能は <see cref="IPlatformServices"/> 越しに扱い、
/// このクラス自体はWin32 P/Invokeを一切持たない（WPF版は直接呼んでいた）。各OSの実装は
...
public sealed partial class StartupCoordinator : IAsyncDisposable
{
    ...
    private readonly IPlatformServices _platform = AvaloniaPlatformServices.Current;
